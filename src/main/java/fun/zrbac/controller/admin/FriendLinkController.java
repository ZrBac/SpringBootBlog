package fun.zrbac.controller.admin;

import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import fun.zrbac.entity.FriendLink;
import fun.zrbac.service.FriendLinkService;
...
public class FriendLinkController {
    ...
    public String friend(Model model, @RequestParam(defaultValue = "1", value = "pageNum") Integer pageNum) {
        ...
        List<FriendLink> lisFriendList = friendLinkService.listFriendLink();
        PageInfo<FriendLink> pageInfo = new PageInfo<FriendLink>(lisFriendList);
